...
> **목적**: "한국 무역 시장은 성장하지만 중소기업은 정체된다"는 기획 가설을 python-쥬피터 노트북을 통해 검증하였습니다.(KOSIS의 csv파일 이용)
...
## AI - ※ AI 기능(광고 태그 추천 / 조회수 예측 / 피드 기반 챗봇)은 별도의 FastAPI 서버가 항상 열려있는게 아니라 동작하지 않을 수 있습니다. 서버 부팅시 기능은 정상 작동합니다.)
